    ...
    try:
        ...
        if action == "shutdown":
            if system == "Windows":
                ...
                await asyncio.to_thread(os.system, "shutdown /s /t 3 /c \"Zenith Assistant: System shutting down in 3 seconds\"")
            ...
            if system == "Windows":
                await asyncio.to_thread(os.system, "shutdown /r /t 3 /c \"Zenith Assistant: System restarting in 3 seconds\"")
